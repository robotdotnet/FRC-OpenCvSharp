    ...
    static partial class Cv2
    {
            ...
            float h = 3, int templateWindowSize = 7, int searchWindowSize = 21)
        {
            ...
            if (dst == null)
                throw new ArgumentNullException(nameof(dst));
            dst.ThrowIfNotReady();
            IntPtr[] srcImgPtrs = srcImgs.SelectPtrs();
        ...
        public static void FastNlMeansDenoisingMulti(IEnumerable<Mat> srcImgs, OutputArray dst,
            ...
            float h = 3, int templateWindowSize = 7, int searchWindowSize = 21)
        {
            IEnumerable<InputArray> srcImgsAsArrays = srcImgs.Select(m => new InputArray(m));
...
// ReSharper disable once InconsistentNaming
            ...
            IEnumerable<Mat> observations, Mat result, double lambda = 1.0, int niters = 30)
        {
            ...
            IntPtr[] observationsPtrs = observations.SelectPtrs();
